//
//  VanillaTrainingTableViewController.swift
//  xPose
//
...
class VanillaTrainingTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var tableView: UITableView!
    
    var cells = [
        TrainingCell(cellText: "Training ohne Geräte", cellImage: UIImage(named: "yogaImage"))
    ]
