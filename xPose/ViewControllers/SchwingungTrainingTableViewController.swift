//
//  SchwingungTrainingTableViewController.swift
//  xPose
//
...
class SchwingungTrainingTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet weak var tableView: UITableView!
    
    var cells = [
        TrainingCell(cellText: "Sitzposition",
                     cellImage: UIImage(named: "yogaImage")),
        TrainingCell(cellText: "Standposition",
                     cellImage: UIImage(named: "yogaImage")),
        TrainingCell(cellText: "Liegeposition und Bauchlage",
                     cellImage: UIImage(named: "yogaImage")),
        TrainingCell(cellText: "Fußposition",
                     cellImage: UIImage(named: "yogaImage")),
        TrainingCell(cellText: "Wadenlagerung",
                     cellImage: UIImage(named: "yogaImage")),
    ]
